        ...
        <tr className="bg-indigo-50/30">
            <td className="px-4 py-3">
                <div className="flex items-center gap-2">
                    <span className="font-bold text-india-blue-dark uppercase tracking-tight text-[0.8rem]">
                        {bowler.name}
                    </span>
                    <span className="text-[0.55rem] font-black text-india-blue/40 border border-india-blue/10 px-1 py-0.5 rounded uppercase">BWL</span>
                </div>
            </td>
            ...
            <td className="px-4 py-3 text-right text-india-blue font-black">{er}</td>
        </tr>
    );
};
